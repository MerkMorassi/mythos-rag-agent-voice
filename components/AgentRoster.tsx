                                        ...
                                        {isEditing ? (
                                            ...
                                            <div className="flex-col" style={{ gap: '0.5rem' }}>
                                                <div className="flex-group">
                                                    <button 
                                                        onClick={() => {
                                                            onSelectAgent(agent.id, 'CHAT');
                                                            onClose();
                                                        }}
                                                        className={`btn btn-sm ${isCurrent ? 'btn-secondary' : 'btn-secondary'}`}
                                                ...
                                                <div className="flex-group">
                                                    <button onClick={() => onOpenGallery(agent.id)} className="btn btn-secondary btn-xs" style={{ flex: 1 }} title="View Agent's Media">GALLERY</button>
                                                    <button onClick={() => handleEditClick(agent)} className="btn btn-secondary btn-xs" style={{ flex: 1 }} title="Modify Agent Profile">EDIT</button>
                                                </div>
                                            </div>
                                        )}
                                    </div>
